...
at the **University of Tennessee**. The ADAM stochastic gradient descent algorithm in it's most general form can be found `here <https://arxiv.org/pdf/1412.6980.pdf/>`_. 
